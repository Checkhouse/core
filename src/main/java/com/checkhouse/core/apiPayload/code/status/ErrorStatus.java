...
public enum ErrorStatus implements BaseErrorCode {
    ...
    _TRACKING_CODE_NOT_FOUND(HttpStatus.NOT_FOUND, "DELIVERY4041", "Tracking code를 찾을 수 없습니다."),
    _INVALID_DELIVERY_STATE(HttpStatus.BAD_REQUEST, "DELIVERY400", "잘못된 배송 상태입니다."),
    _DUPLICATE_TRACKING_CODE(HttpStatus.CONFLICT, "DELIVERY409", "중복된 송장 번호입니다."),
